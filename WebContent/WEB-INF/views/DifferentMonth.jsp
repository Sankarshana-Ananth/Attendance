...
<div class="outer">
    ...
    <div class="header">
        ...
        <table class="tableOne" border=0 style="margin-right:150px" align = left>
            <%  AccessDatabase db = (AccessDatabase)request.getAttribute("database");
                ...
                String id = "4";
                String year = "2020";
                int curMon = today.getMonth();
                int nextMon = today.getMonth()+1;
                Month mon1 = Month.of(curMon);
                Month mon2 = Month.of(nextMon);
                ...
                out.println(" <b>\n" +
                        ...
                        "\n" +
                        "                <tr>\n" +
                        "                    <td style = 'text-align:center' height='20'><font style='color: black'> " + id + " </font></td>\n" +
        ...
        <%
            ...
            out.println("     <div width='50%' align='right'>\n" +
                    ...
                    "                <td style = 'text-align:right' height='20' > 25 </td>\n" + db.getAttended()  + "</font> </td>\n"+
                    "            </tr>\n" +
                    "\n" +
                    "            <tr>\n" +
                    "                <td style = 'text-align:left' height='20' width='60%'><font style='color: black'> On Duty </font></td>\n" +
                    "                <td style = 'text-align:right' height='20'> <font style='color: green'>"+ db.getOD() + "</font> </td>\n" +
                    "            </tr>\n" +
                    "\n" +
                    "            <tr>\n" +
                    ...
                    "                <td style = 'text-align:right' height='20'> <font style='color: brown'>"+db.getCardNotPunched() +"</font> </td>\n" +
                    "            </tr>\n" +
                    "\n" +
                    "        </table>\n" +
                    "        </table>\n" +
    ...
    <div id="output"></div>
        ...
        for(i=0;!db.status[i].isEmpty();i++){
            ...
            out.println("         <tr>\n" +
                    ...
                    "            <td style = \"text-align:center\" height=\"40\"> <font style=\"color: "+colour+"> < button onclick=\"document.getElementById('id01').style.display='block'\" style=\"width:auto; -webkit-box-align: center \"> " + db.status[i] + "  </button> </font> </td>\n" +
                    "         </tr>   ");
            reason = db.reason[i];
        }
    }catch(Exception E){
    ...
    <div id="id01" class="modal">
        ...
        <div class="modal-content animate" >
            ...
            <div class="container"><centre>
                <label for="cars"> Choose what you want you apply for : </label>
                <form action="DifferentMonth.jsp" method="post">
    ...
    <div id="permissions" class="modal">
        ...
        <div class="modal-content animate" >
            ...
            <div class="container"><centre>
                ...
                <nbr>
                    <a id="trigger" href="#"> Open calender? </a>
                    <div id="output1"> </div>
                    <script type="text/javascript">
                        //
    ...
    <button onclick="document.getElementById('permissions').style.display='block'" style="width:auto; -webkit-box-align: center ">  Apply Permissions  </button>
